...
\def\ProjetTitle{Development foundation for legacy transportation software modernization}
...
These are delivered as a snapshot from M-line's GitHub repositories (not the full repositories themselves). The snapshot will include:
\begin{itemize}
...
\end{itemize}
The academic supervisor, opponent, and Committee receive access to the previously mentioned on request. Similarly, a demo of the project will also be made accessible upon request.

\medskip
\noindent \textbf{Company consent and consultant.} M-line software s.r.o. has approved the project scope and consents to its academic delivery and presentation as described above. The company consultant is a software engineer responsible for the biggest portion of the legacy stack the project interacts with. He can be reached on \href{mailto:jiri.krhanek@m-line.cz}{jiri.krhanek@m-line.cz}.
