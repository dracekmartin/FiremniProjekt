...
\def\ProjectTitle{My research project}
...
We recommend the first two levels of C4 model --- \url{https://c4model.com/}.
...
\section{Evaluation}
In this section, you should elaborate on how you plan to test and evaluate the software.
If your software is primarily designed to run an experiment, you should present results of the experiment.
If your software aims to support users in a given activity, you should present the results of a user study demonstrating the benefits for said users.
...
Is there a demonstration scheduled for the research group?
...
\begin{tabular}{ | m{11em} | m{23em} | m{2.5cm} | m{1.3cm} | }
 ...
 Prototype & Implementation & Month 1 & 20 \\
           & Testing & Month 2 & 4 \\
 \hline
 First version & Implementation & Months 3 -- 4 & 40 \\
               & Deployment & Month 4 & 2 \\
               & Documentation & Month 4 & 6 \\
 \hline
 Evaluation & & Months 4 -- 5 & 5 \\
 \hline
\end{tabular}
